...
#define COROUTINE(function, type, time, interval)\
	Engine::Get().SetTimer(BINDFUNCTION(function, type), time, interval, reinterpret_cast<size_t>(this));

#ifdef _DEBUG
#define TraceNew new ( _NORMAL_BLOCK , __FILE__ , __LINE__ )
...
enum class Color : unsigned char
{
	...
	BrightGreen = Green | Intensity,
	BrightBlue = Blue | Intensity,
	BrightWhite = White | Intensity
};
